public class Main {
    public static void main(String[] args) {
        ...
        int age7 = 14;
        if (age7 < 5) {
            System.out.println("Если возраст " + age7 + " не может кататься на атракционе");
        } else if (age7 < 14) {
            System.out.println("Если возраст " + age7 + " может кататься на атракционе в слпровождении взрослого");
        } else {
